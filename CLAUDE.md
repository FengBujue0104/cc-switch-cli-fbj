...
**Product contract is `README.md` / `README_EN.md`.** This is a lightweight personal fork of [SaladDay/cc-switch-cli](https://github.com/saladday/cc-switch-cli). Do not follow leftover upstream copy that talks about a six-harness product. Keep this file aligned with `AGENTS.md`.
